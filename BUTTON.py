...
from db_manager import DBManager  # אם הקובץ נקרא db_manager.py
...
button_topic = "pr/home/1234567/sts"
...
class ConnectionDock(QDockWidget):
    ...
    def push_button_click(self):
        ...
        db.add_record(
            ...
            receiver="Button",
            transmitter="User",
            topic=self.ePublisherTopic.text(),
            subscriber="GUI",
            message=message
        )
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('SMART BUTTON')        
